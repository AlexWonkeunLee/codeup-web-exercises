...
if (enter == true){
    ...
    if (isNaN(parseInt(number))){
        ...
        alert("This number + 100 is " + (parseInt(number) + 100));
        if (number >= 0){
...
var totalBill = parseInt(prompt("Enter your bill here: "));
alert("Your lucky number was " + luckyNumber + ". Your old price was " + totalBill + ". Your new price is " +
